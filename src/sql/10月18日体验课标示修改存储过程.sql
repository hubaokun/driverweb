...
DELIMITER ;;
CREATE  FUNCTION `getCoachAccompanyOrder`(coid int(11)) RETURNS int(11)
BEGIN
...
DELIMITER ;;
CREATE  FUNCTION `getcoachaccompanystate`(coachid int(11),datecount int(11),datestart text,starthour int(11),endhour int(11)) RETURNS tinyint(4)
BEGIN
...
DELIMITER ;;
CREATE  FUNCTION `getcoachstate`(coachid int(11),datecount int(11),datestart text,starthour int(11),endhour int(11),subjectid int(11)) RETURNS varchar(10) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
BEGIN
