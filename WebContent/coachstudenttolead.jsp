...
function dataToLead(){
	if (confirm("确认导入教练学员关系信息？")) {
		$("#labelForm").attr("action", "coachStudentDataToLead.do").submit();
	}
}
function back(){
	history.go(-1);
...
<input type="hidden" id="change_id" name="change_id" value="${change_id}"/>
