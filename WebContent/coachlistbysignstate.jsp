			...
			<div id="content_form_top" >
					...
					<div class="searchbutton" style="width:80px;">
						...
						<div class="table_button_text" style="font-size: 12px;line-height: 38px;" onclick="alertDataExportBox();">数据导出</div>
										...
										<div class="searchbutton" onclick="searchBySignstate()">
						<img src="imgs/common/searchicon.png" width=22px height=22px
							style="margin-top: 9px;" >
					</div>
					
					<div class="serchcontentdiv"style="float: left; margin-left: 20px; width: 230px"  >
						<input  type="text" class="searchdiv" style="width:110px;font-family: 微软雅黑;text-align: center;" value="明星教练签约状态" readonly="readonly"/>
								<select id="signstate" class="searchdiv" style="width: 110px;">
										<option value="-1">不限</option>
										<option id="signstate0" value="0">未签约</option>
										<option id="signstate1" value="1" selected="selected">已签约未过期</option>
										<option id="signstate2" value="2">已签约过期</option>
								</select>
					</div>
					
					<div class="serchcontentdiv"style="float: left; margin-left: 20px; width: 320px"  >
							<input type="text" class="searchdiv" style="width: 110px;text-align: center;font-family: 微软雅黑;" value="签约到期日期区间" readonly="readonly">
							<input id="signexpiredmin" onclick="WdatePicker({startDate:'',dateFmt:'yyyy-MM-dd'})" type="text" class="searchdiv" style="width: 80px;text-align: center;font-family: 微软雅黑;" value="${signexpiredmin}" >
							<input type="text" class="searchdiv" style="width: 25px;text-align: center;font-family: 微软雅黑;" value="到" readonly="readonly">
							<input id="signexpiredmax" onclick="WdatePicker({startDate:'',dateFmt:'yyyy-MM-dd'})" type="text" class="searchdiv" style="width: 80px;text-align: center;font-family: 微软雅黑;" value="${signexpiredmax}">
					</div>
					
					<div class="serchcontentdiv" style="float: left; margin-left: 20px; width: 140px" >
						<input  type="text" class="searchdiv" style="width: 50px;text-align: center;font-family: 微软雅黑;" value="姓名" readonly="readonly">
						<input id="realname" type="text" class="searchdiv" style="width:80px;font-family: 微软雅黑;" value="${searchname}"/>
					</div>

					<div class="serchcontentdiv" style="float: left; margin-left: 20px; width: 156px" >
...
<div class="serchcontentdiv"style="float: left; margin-left: 20px; width: 160px"  >
				...
				<table border="0" cellspacing="0" cellpadding="0"
					...
					<s:iterator value="cuserlist" var="cuser">
						...
						<td style="width: 40px;" class="border_right_bottom"><input type="checkbox" name="checkbox" value="${coachid}" ></td>
							...
							<s:if test="signstate==1">
							<td style="width: 100px;" class="border_right_bottom">已签约未到期</td>
							</s:if>
							<s:elseif test="signstate==2">
								<td style="width: 100px;" class="border_right_bottom">已签约到期</td>
							</s:elseif>
							<s:else >
							<td style="width: 100px;" class="border_right_bottom">未签约</td>
							</s:else>
							<td style="width: 150px;" class="border_right_bottom">
								<s:date name="signexpired" format="yyyy-MM-dd" />
							</td>
