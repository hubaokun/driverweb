		...
		<div id="content_form">
			<div id="content_form_top">
					...
					<div class="searchbutton" style="width:80px;">
						<div class="table_button_edit_icon"></div>
						<div class="table_button_text" style="font-size: 12px;line-height: 38px;" onclick="getEnrollStudent();">报名学员</div>
					</div>
...
-->							
								<div class="table_edit">
									<a href="getUserState.do?studentid=${studentid}&index=1&change_id=3&state=6"
										style="text-decoration: none; cursor: pointer;">跟进详情&nbsp&nbsp&nbsp&nbsp</a>
									<a href="recoverUser.do?studentid=${studentid}&index=1&change_id=3"
										style="text-decoration: none; cursor: pointer;">恢复</a>
								</div>
							</td>
