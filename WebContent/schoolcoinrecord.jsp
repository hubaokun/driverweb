                    ...
                    <div id="ssearch" style="width: 100%; height: 75px; border-bottom: 1px solid #eaeff2;">
                        ...
                        <div style="height: 100%; line-height: 75px; float:left; margin-left: 20px;">
                           ...
                           <s:if test="receiverid!=null">
                             ...
                             <s:if test="coinnum!=0">
							<a href="javascript:reclaimSchoolCoin('${receivername}','${receiverid}')">全部回收${receivername }的小巴币</a>
							</s:if>
                           </s:if>
                          
                             <input type="button"  value="查询" onclick="goSchoolCoinRecord()"
									...
									<script type="text/javascript">
										...
										function setPage(container, count,
											...
											function setPageList() {
												if (pageindex == i) {
													a[a.length] = "<a onclick=\"goPage('goSchoolCoinRecord.do?ownerid="
															+ ownerid
															+ "&ownertype="
															+ ownertype
															+ "&starttime="
											...
											if (pageindex == count) {
												a[a.length] = "<a onclick=\"\" class=\"hide_page_next unclicknext\"></a> 共"
														...
														+ "<a class=\"jump_btn\" onclick=\"gotoPage('goSchoolCoinRecord.do?ownerid="
														+ ownerid
														+ "&ownertype="
														+ ownertype
														+ "&starttime="
