...
function showOrderDetail(obj){
	if(obj.code==1){
		...
		if(order.need_uncomplaint==1 && order.coachstate!=5){
			//content_list=content_list+'<a href="coursearrange.jsp?coachid='+order.coachid+'"><span class="sure-btn">取消投诉</span></a>';
			$("#tscontent").html("您的投诉小巴正在加紧处理，请耐心等待!");
		}else{
			$("#tscontent").html("");
		}
