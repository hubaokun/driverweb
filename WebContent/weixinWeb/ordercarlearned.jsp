...
<body>
  <div class="container">
      <div class="row carlearn-head carlearn-head-grey">
          <span>学车完成<i style="font-style:normal;">（待评价）</i></span>
      </div>
      ...
      <div class="row carlearn-sure-btn">
      	<div class="col-md-12 col-sm-12 col-xs-12">
        	<a href="evaluatecoach.jsp"><span class="evaluate-btn blue"  style="display:block;width:100%;"><i class="icon  icon-edit"></i>评价</span></a>
        </div>
      </div>  
