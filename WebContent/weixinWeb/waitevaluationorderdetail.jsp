...
function showOrderDetail(obj){
	if(obj.code==1){
    	...
    	content_list=content_list+'<a href="evaluatecoach.jsp?orderid='+order.orderid+'"><span class="complain-btn">立即评价</span></a>';
    	if(order.can_complaint==1){
    		content_list=content_list+'<a href="complaincoach.jsp?orderid='+order.orderid+'"><span class="sure-btn">投诉</span></a>';
    	}
