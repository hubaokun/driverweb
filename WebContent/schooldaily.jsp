...
function search(){
	...
	window.location.href = "schooldaily.do?addtime="+addtime;
}
...
<div id="content_form_table">
				<table border="0" cellspacing="0" cellpadding="0"
					...
					<s:iterator value="schooldailylist" status="st">
						<tr class="tr_td">
							...
							<td style="width: 100px;" class="border_right_bottom">${dayorderhour}</td>
				...
				var container = container;
					...
					var a = [];
					  ...
					  if (pageindex == 1) {
					    ...
					    a[a.length] = "<a onclick=\"previousPage("+pageindex+",'schooldaily.do?addtime="+addtime+"&')\" class=\"page_prev\"></a>";
					  }
					  function setPageList() {
					    if (pageindex == i) {
					      a[a.length] = "<a onclick=\"goPage('schooldaily.do?addtime="+addtime+"&',"+i+")\" class=\"on\">" + i + "</a>";
					    } else {
					      a[a.length] = "<a onclick=\"goPage('schooldaily.do?addtime="+addtime+"&',"+i+")\">" + i + "</a>";
					    }
					  }
					  //总页数小于10
					  if (count <= 10) {
					    ...
					    if (pageindex <= 4) {
					      ...
					      a[a.length] = "...<a onclick=\"goPage('schooldaily.do?addtime="+addtime+"&',"+count+")\">" + count + "</a>";
					    } else if (pageindex >= count - 3) {
					      a[a.length] = "<a onclick=\"goPage('schooldaily.do?addtime="+addtime+"&',1)\">1</a>...";
					  ...
					  if (pageindex == count) {
						    ...
						    "<a class=\"jump_btn\" onclick=\"gotoPage('schooldaily.do?addtime="+addtime+"&',"+$("#pageSize").val()+")\")\">"+
						    "<a id='page_msg'></a>";
						  } else {
						    a[a.length] = 
						    	"<a onclick=\"nextPage("+$("#pageIndex").val()+",'schooldaily.do?addtime="+addtime+"&')\" "+
