				...
				<table border="0" cellspacing="0" cellpadding="0"
					...
					var a = [];
					 ...
					 if (pageindex == 1) {
					    ...
					    a[a.length] = "<a onclick=\"previousPage("+pageindex+",'getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&')\" class=\"page_prev\"></a>";
					  }
					  function setPageList() {
					    if (pageindex == i) {
					      a[a.length] = "<a onclick=\"goPage('getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&',"+i+")\" class=\"on\">" + i + "</a>";
					    } else {
					      a[a.length] = "<a onclick=\"goPage('getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&',"+i+")\">" + i + "</a>";
					    }
					  }
					  //总页数小于10
					  if (count <= 10) {
					    ...
					    if (pageindex <= 4) {
					      ...
					      a[a.length] = "...<a onclick=\"goPage('getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&',"+count+")\">" + count + "</a>";
					    } else if (pageindex >= count - 3) {
					      a[a.length] = "<a onclick=\"goPage('getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&',1)\">1</a>...";
					  ...
					  if (pageindex == count) {
						    ...
						    "<a class=\"jump_btn\" onclick=\"gotoPage('getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&',"+$("#pageSize").val()+")\")\">"+
						    "<a id='page_msg'></a>";
						  } else {
						    a[a.length] = 
						    	"<a onclick=\"nextPage("+$("#pageIndex").val()+",'getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward+"&index="+index+"&change_id"+j+"&')\" "+
						    	"class=\"page_next\"></a> 共"+count+"页 到第 "+
						    "<input type=\"text\" class=\"jump_num\" id=\"topage\"/> 页"+
						    "<a class=\"jump_btn\" onclick=\"gotoPage('getRecommendDetail.do?coachid="+coachid+"&invitecount="+invitecount+"&checkPastCount="+checkPastCount+"&earnCount="+earnCount+"&totalreward="+totalreward +"&',"+$("#pageSize").val()+")\">"+
						    "<a id='page_msg'></a>";
						  }
