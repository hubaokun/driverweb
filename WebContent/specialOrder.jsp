...
<script type="text/javascript" src="js/specialOrder.js"></script>
...
//学员取消订单教练不同意，学员又去学车
function alreadyLearn(orderid){
	if(confirm("学员取消订单教练不同意，但最后学员又去跟这个教练学车了,确认后，请登录教练端APP，此时教练任务中有此订单的确认下车按钮，点击“确认下车”")){
		
		window.location.href="alreadyLearn.do?orderid="+orderid;
	}
}
//学员取消订单教练不同意，最后学员未去学车
function noLearn(orderid){
	if(confirm("学员取消订单后，教练不同意，最后学员没有去学车,登录教练端APP,在任务单中找到此单，点击“同意取消”，小巴币会自动退还给学员")){
		
		window.location.href="noLearn.do?orderid="+orderid;
	}
}
	...
	<div id="content">
		...
		<div id="content_form">
			<div id="content_form_top" style="height:auto;">
					<div class="searchbutton" onclick="searchSpecialOrder()">
				...
				<table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
					...
					<s:iterator value="orderlist" var="cuser">
						<tr class="tr_td">
							...
							<td style="width: 60px;" class="border_right_bottom">${cuserinfo.realname}</td>
							<td style="width: 100px;" class="border_right_bottom">${cuserinfo.phone}</td>
							<td style="width: 60px;" class="border_right_bottom">${studentinfo.realname}</td>
							...
							<td style="width: 60px;" class="border_right_bottom">${total}</td>
							<s:if test="paytype==1">
							...
							<td style="width: 100px;" class="border_right_bottom">
								<s:if test="coachstate==5">
									学员取消教练不同意
								</s:if>
								<s:elseif test="studentstate==5">
									学员投诉
								</s:elseif>
							...
							<td style="width: 300px;" class="border_noright_bottom">
								...
								<div class="table_lookdetail" >
									<a href="javascript:noLearn('${orderid}')"
										style="text-decoration: none; cursor: pointer;font-family: 微软雅黑; "><b>学员未学车</b></a>
								</div>	
								
								<div class="table_lookdetail" >
									<a href="javascript:alreadyLearn('${orderid}')"
										style="text-decoration: none; cursor: pointer;font-family: 微软雅黑; "><b>学员已学车</b></a>
								</div>	
				...
				var container = container;
					...
					var a = [];
					  ...
					  if (pageindex == 1) {
					    ...
					    a[a.length] = "<a onclick=\"previousPage("+pageindex+",'specialOrder.do?coachphone="+coachphone+"&studentphone="+studentphone+"&startminsdate="+startminsdate+"&startmaxsdate="+startmaxsdate+
					  ...
					  function setPageList() {
					    if (pageindex == i) {
					      a[a.length] = "<a onclick=\"goPage('specialOrder.do?coachphone="+coachphone+"&studentphone="+studentphone+"&startminsdate="+startminsdate+"&startmaxsdate="+startmaxsdate+
					  ...
					  if (pageindex == count) {
						    ...
						    "<a class=\"jump_btn\" onclick=\"gotoPage('specialOrder.do?coachphone="+coachphone+"&studentphone="+studentphone+"&startminsdate="+startminsdate+"&startmaxsdate="+startmaxsdate+
						    ...
						    a[a.length] = 
						    	"<a onclick=\"nextPage("+$("#pageIndex").val()+",'specialOrder.do?coachphone="+coachphone+"&studentphone="+studentphone+"&startminsdate="+startminsdate+"&startmaxsdate="+startmaxsdate+
