	...
	<div id="content">
		...
		<div id="content_form">
			<div id="content_form_top">
					...
					<div class="searchbutton" style="width:100px;">
						<div class="table_button_edit_icon"></div>
						<div class="table_button_text" style="font-size: 12px;line-height: 38px;" onclick="getEnrolledStudent();">已报名学员</div>
					</div>
...
<!-- 								<div class="table_lookdetail">
									<a href="getStudentDetail.do?studentid=${studentid}&index=1&change_id=3"
										style="text-decoration: none; cursor: pointer;">查看详情</a>
								</div>
-->							
								<div class="table_edit">
									<a href="getUserState.do?studentid=${studentid}&index=1&change_id=3"
										style="text-decoration: none; cursor: pointer;">跟进&nbsp&nbsp&nbsp&nbsp</a>
									<a href="deleteUser.do?studentid=${studentid}&index=1&change_id=3"
										style="text-decoration: none; cursor: pointer;">删除</a>
								</div>
							</td>
				...
				var container = container;
					...
					var a = [];
					  ...
					  if (pageindex == 1) {
					    ...
					    a[a.length] = "<a onclick=\"previousPage("+pageindex+",'getEnrollStudentByKeyword.do?searchname="+realname+"&searchphone="+phone+"&minsdate="+starttime+"&maxsdate="+endtime +"&minenrollsdate=" + startenrolltime + "&maxenrollsdate="
						+ endenrolltime +"&index="+index+"&change_id"+j+"&')\" class=\"page_prev\"></a>";
					  }
					  function setPageList() {
					    if (pageindex == i) {
					      a[a.length] = "<a onclick=\"goPage('getEnrollStudentByKeyword.do?searchname="+realname+"&searchphone="+phone+"&minsdate="+starttime+"&maxsdate="+endtime +"&minenrollsdate=" + startenrolltime + "&maxenrollsdate="
					  ...
					  if (pageindex == count) {
						    ...
						    "<a class=\"jump_btn\" onclick=\"gotoPage('getEnrollStudentByKeyword.do?searchname="+realname+"&searchphone="+phone+"&minsdate="+starttime+"&maxsdate="+endtime+"&minenrollsdate=" + startenrolltime + "&maxenrollsdate="
							+ endenrolltime +"&index="+index+"&change_id"+j+"&',"+$("#pageSize").val()+")\")\">"+
						    "<a id='page_msg'></a>";
						  } else {
						    a[a.length] = 
						    	"<a onclick=\"nextPage("+$("#pageIndex").val()+",'getEnrollStudentByKeyword.do?searchname="+realname+"&searchphone="+phone+"&minsdate="+starttime+"&maxsdate="+endtime+"&minenrollsdate=" + startenrolltime + "&maxenrollsdate="
...
// 					  a[a.length]="<a href='#' onclick='addunit()' style='float: right;position: relative;right: 50px;padding: 0px; margin: 0px; top: 3px;'><img src='imgs/add_.png'></a>";
	...
	<div id="add_sec" style="position: fixed; width: 100%; height: 300px;z-index: 300; top:20%;left:25%;display:none">
		...
		<form action="addEnrollStudentByPhone.do" method="post" id="form_submit">
